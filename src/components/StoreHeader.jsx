  ...
  return <>
    ...
    <header className="store-header">
      ...
      <div className="nav-wrap"><nav className="container-wide nav-bar">
        ...
        <NavLink to="/">Beranda</NavLink><a href="#physical">Produk Fisik</a><a href="#digital">Produk Digital</a><a href="#promo">Promo</a><a href="#articles">Artikel</a><Link to="/checkout">Konfirmasi Pembayaran</Link>
